...
public interface Indicator {
	 ...
	 * 目前提供的子类
	 * {@link gongxm.view.indicator.transition.OnTransitionTextListener}
	 * 
	 ...
	 * 设置滑动块<br>
	 * 设置它可以自定义滑动块的样式。<br>
	 * 目前提供的子类 {@link gongxm.view.indicator.slidebar.ColorBar}
	 * {@link gongxm.view.indicator.slidebar.DrawableBar}
	 * {@link gongxm.view.indicator.slidebar.LayoutBar}
	 * 
	 * @param scrollBar
	 */
